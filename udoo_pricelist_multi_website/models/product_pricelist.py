...
class ProductPricelist(models.Model):
    ...
    def _search_get_detail(self, website, order, options):
        """Extiende el dominio de búsqueda para incluir listas del sitio web actual o globales."""
        res = super(ProductPricelist, self)._search_get_detail(website, order, options)
        # Permitir listas de precios que sean globales (public_website_ids vacío) o asignadas a este website
